...
kotlin {
    ...
    swiftExport {
        moduleName = "EnvLogger"
        flattenPackage = "io.github.kotlinmania.envlogger"
    }

    android {
        namespace = "io.github.kotlinmania.envlogger"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "env-logger-kotlin", version.toString())

    pom {
        name.set("env-logger-kotlin")
        description.set("Kotlin Multiplatform port of rust-cli/env_logger - A logging implementation for `log` which is configured via an environment variable")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/env-logger-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/env-logger-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/env-logger-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/env-logger-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleDebugIosFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseIosFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugMacosFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseMacosFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugTvosFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseTvosFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugWatchosFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseWatchosFatFrameworkForEnvLoggerXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForEnvLoggerXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForEnvLoggerXCFramework",
