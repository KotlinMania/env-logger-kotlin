...
This file is the quick-reference operating contract for env-logger-kotlin. The longer
...
env-logger-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`env_logger`](https://crates.io/crates/env_logger). Upstream Rust is the behavioral oracle while the
