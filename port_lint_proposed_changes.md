...
| `src/commonTest/kotlin/io/github/kotlinmania/envlogger/writer/BufferTest.kt` | `// port-lint: tests writer/buffer.rs` | `// port-lint: tests writer/buffer.rs` | `writer/buffer.rs` | `port-lint provenance header matched only after fallback normalization: 'tests:writer/buffer.rs' vs expected 'writer/buffer.rs'` |
...
| `src/commonTest/kotlin/io/github/kotlinmania/envlogger/LoggerTest.kt` | `// port-lint: tests logger.rs` | `// port-lint: tests logger.rs` | `logger.rs` | `port-lint provenance header matched only after fallback normalization: 'tests:logger.rs' vs expected 'logger.rs'` |
...
| `src/commonTest/kotlin/io/github/kotlinmania/envlogger/fmt/KvTest.kt` | `// port-lint: tests fmt/kv.rs` | `// port-lint: tests fmt/kv.rs` | `fmt/kv.rs` | `port-lint provenance header matched only after fallback normalization: 'tests:fmt/kv.rs' vs expected 'fmt/kv.rs'` |
